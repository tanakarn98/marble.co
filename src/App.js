...
import bgClouds from "./images/bgClouds.png";
...
const App = () => {
  ...
  return (
    <>
      <img src={bgClouds} className="bgClouds" />
      <img src={topImages} className="topImage"></img>
      ...
      <h2 className="aboutTitle">
        こんにちは、<img src={Marbleco_logo}></img>です。
      </h2>
      <div className="aboutFlex container">
        <img src={packageDesign}></img>
        <p>
      ...
      <div className="container">
        <div className="trigger">
          ...
          <img src={topSnow} className="topSnow"></img>
          <div className="white">
          ...
          <div className="soundEventContainer">
            <div className="soundEvent">
              ...
              <div className="soundBook">
                ...
                <img src={minibook}></img>
              </div>
            </div>
          </div>
          <img src={bottomSnow} className="bottomSnow"></img>
          <div className="titleContainer">
            <p className="title">参加方法</p>
          </div>
          <p className="center">
          ...
          <div className="titleContainer">
            <p className="title">お問い合わせ / お申し込み</p>
          </div>
      ...
      <img src={bottomSnow} className="footerImage"></img>
      <div className="footer">
        <p>
          主催
          <a href="https://www.marble-co.net/portfolio">
            <img src={Marbleco_logo}></img>
          </a>
        </p>
      </div>
    </>
